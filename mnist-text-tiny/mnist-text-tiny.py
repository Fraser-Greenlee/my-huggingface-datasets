"""Highly compressed MNIST text dataset."""
...
*Modified images to be ~1/6 the original area.*
...
Data format:
- text: (11 x 9 tokens, 99 tokens total): Textual representation of MNIST digit, for example:
```
00 down ! ! ! ! ! ! ! ! !
01 down ! ! * K ` ` a ^ !
02 down ! ! ` ` ` ` 5 * !
...
08 down ! ! ! ! ! ! ! ! !
```
- label: Just the number of the matching label.
...
@dataset{dataset,
    ...
    month = {2},
    pages = {},
    title = {MNIST tiny text dataset.},
    doi = {}
}
"""

_TRAIN_DOWNLOAD_URL = "https://raw.githubusercontent.com/Fraser-Greenlee/my-huggingface-datasets/master/data/mnist-text-tiny/train.json.zip"
_TEST_DOWNLOAD_URL = "https://raw.githubusercontent.com/Fraser-Greenlee/my-huggingface-datasets/master/data/mnist-text-tiny/test.json"
...
class MnistTextTiny(datasets.GeneratorBasedBuilder):
